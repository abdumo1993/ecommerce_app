...
class GetUserModel {
  ...
  GetUserModel fromJson(Map<String,dynamic> json) {
    GetUserModel user  = GetUserModel();
      ...
      if (json['defaultShippingAddress'] != null && json['defaultShippingAddress'] != "") user.defaultShippingAddress = json['defaultShippingAddress'];
      if (json['billingAddress'] != null && json['billingAddress'] != "") user.billingAddress = json['billingAddress'];
      if (json['phoneNumber'] != null && json['phoneNumber'] != "") user.phoneNumber = json['phoneNumber'];
    return user;
  }
  Map<String, dynamic> toJson() {
    return{
      ...
      if (lastname != null && lastname != "") "lastname" :lastname,
      if (email != null && email != "") "email" : email,
      if (defaultShippingAddress != null && defaultShippingAddress != "") "defaultShippingAddress" : defaultShippingAddress,
      if (billingAddress != null && billingAddress != "") "billingAddress" : billingAddress,
